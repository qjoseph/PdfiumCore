...
namespace PdfiumCore
{
    partial class NativeMethods
    {
        ...
        public static void FPDFDOC_ExitFormFillEnvironment(IntPtr hHandle)
        {
            lock (LockString)
            {
                // Enricosoft: here we get an exception
        ...
        #endregion Custom Load/Save Logic
        ...
        #endregion Save/Edit Structs and Flags
    }
}